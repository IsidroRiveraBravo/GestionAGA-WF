...
{
    public class CGFirmaE
    {
        public int Id_Firma {get; set; }   // ] [int] IDENTITY(1,1) NOT NULL,
	    public int  IdControlGestion {get; set; }   //] [int] NULL,
	    public string FirmadoPor {get; set; }   //] [nvarchar](100) COLLATE SQL_Latin1_General_CP1_CI_AI NULL,
	    public DateTime FechaFirma {get; set; }   //] [datetime] NULL,
